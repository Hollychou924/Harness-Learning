...
## 从其他章移入的素材(2026-06-07,待写作时纳入)

- **团队标准化推广(原 E5 Q5)**:个人掌握 vs 团队标准化怎么平衡。阿里把单仓 AI 代码率从 24.86% 拉到 90.54%,靠的不是个人强 prompt,而是全员同一套五件套:AGENTS.md / Spec / 工具化环境 / 测试门禁 / 多 Agent 评审 + 变更管理。SDD-RIPER 团队一周跑通、5 人 7 天干完 20 人数周的活。→ 用于 E9 提案的"团队落地 / 推广路径"部分。
  - 素材:`topics/aliyun-cloud-developer-agent-collection.md`(90% 五件套、SDD 团队落地)、`topics/agentway-harness-books.md`(原则 10:团队制度比个人技巧重要)。
