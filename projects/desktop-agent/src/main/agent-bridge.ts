...
import type { StdoutMessage, StdinMessage, AgentConfig } from '../agent/src/protocol.js'
...
export class AgentBridge {
  ...
  startTask(session_id: string, message: string, config: AgentConfig, workspace_dir?: string): void {
    this.send({ type: 'chat_request', session_id, message, config, workspace_dir })
  }
