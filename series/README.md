...
## 系列对外发布标题规范(2026-06-07 定)

**系列名:《AI 产品经理读懂 Harness》**(传达:成体系、系统化干货、AI PM 视角的求职作品集)

每篇对外发布标题统一格式:**《AI 产品经理读懂 Harness》(N/9) · XX篇——副标题**

| 期 | 对外发布标题 | 内部工作台章名(不变) |
|----|------------|------------------|
| E1 | 《AI 产品经理读懂 Harness》(1/9) · 全景篇——什么是 Harness,为什么它比模型更重要 | E1 什么是 Harness:从认知到能力模型 |
| E2 | 《AI 产品经理读懂 Harness》(2/9) · 循环与编排篇——任务怎么跑起来又不跑飞 | E2 Agent 循环与编排 |
| E3 | 《AI 产品经理读懂 Harness》(3/9) · 工具篇——给 Agent 一把钥匙还是一串钥匙 | E3 工具系统与 MCP |
| E4 | 《AI 产品经理读懂 Harness》(4/9) · 上下文与记忆篇——一次对话 Agent 到底带着什么 | E4 上下文与记忆 |
| E5 | 《AI 产品经理读懂 Harness》(5/9) · 多 Agent 篇——任务怎么拆、怎么协作、怎么不互相踩 | E5 多 Agent 系统 |
| E6 | 《AI 产品经理读懂 Harness》(6/9) · 安全与权限篇——能理解,不等于能执行 | E6 安全与权限 |
| E7 | 《AI 产品经理读懂 Harness》(7/9) · 自进化篇——怎么让 Agent 越用越聪明 | E7 如何实现 Harness 自进化 |
| E8 | 《AI 产品经理读懂 Harness》(8/9) · 评估篇——怎么证明 Agent 真的变好了 | E8 评估、可观测性与数据驱动迭代 |
| E9 | 《AI 产品经理读懂 Harness》(9/9) · 提案篇——给 DeepSeek 桌面端 Agent 的产品提案书 | E9 给 DeepSeek 的产品提案书 |

> 内部各章 README/draft 的 `# EN｜...` 标题保持不变(工作台用);对外发布(公众号/社区/简历附件)统一用上表第二列。
