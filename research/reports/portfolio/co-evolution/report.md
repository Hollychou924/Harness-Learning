...
>
> _Generated 2026-05-24T09:11:56+00:00 from `wiki/compiled/` (DeepSeek Agent Harness PM 应聘材料)_
...
**A.1 隐喻反证 (本报告"协同进化"假设)**:本报告假设模型与 Harness "协同进化",但中文 63 篇语料显示**完全不同的隐喻框架**:

| 隐喻范畴 | 中文社区 | 硅谷一手文档 |
|---|---|---|
| **Pair Programming** | **0 / 0 (TF/DF)** | 高频 |
| 驾驭 (harness 缰绳) | 142 / 24 | 中性 |
| 控制论 / Cybernetic | 34 / 4 | 几乎不出现 |
| 协作 / 协同 | 中性占比一般 | 高频 |

**Pair Programming 在 63 篇中 0 命中** — 中文社区话语体系里 AI 是被驾驭对象,不是协作者。

**A.2 对协同模型的影响**:本报告 §3 关于"模型与 Harness 共进化"的论述,在中文市场需要被翻译成"如何驾驭一个能力越来越强的 AI"——同样的工程目标,不同的产品语言。**DeepSeek 在中国市场宣传协同进化时,文案应避免"伙伴"、"协作"等隐喻**,而采用"驾驭更强的马"、"系统持续进化的能力边界"等驾驭范式表达。否则会与中文社区已有的 142 TF "驾驭" 心智失配。
