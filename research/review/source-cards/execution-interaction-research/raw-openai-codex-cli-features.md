...
Endpoints, parameters, and responses](/api/reference/overview)[Docs

Guides, concepts, and product docs for Codex](/codex)[Use cases

Example workflows and tasks teams hand to Codex](/codex/use-cases)[Apps SDK
...
Publish and measure ads in ChatGPT](/ads)[Showcase
...
Programs, meetups, and support for builders](/community)* [Running in interactive mode](#running-in-interactive-mode)
...
Command Line Options](/codex/cli/reference)Codex supports workflows beyond chat. Use this guide to learn what each one unlocks and when to use it.
