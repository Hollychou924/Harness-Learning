---
id: source-card-community-aliyun-Agent-Skill规范构建与设计模式
type: source-card
status: triaged
source: wiki/raw/community-posts/aliyun-cloud-developer/2026-05-12-Agent-Skill规范构建与设计模式.md
updated: 2026-05-26
---

# 阿里云开发者文章卡 · Agent Skill规范、构建与设计模式

## 原文信息

- 来源: 阿里云开发者 微信公众号
- 作者: 珂罗
- 发布时间: 2026/05/12 08:30:00
- URL: https://mp.weixin.qq.com/s/LCpiLyLnRn5WyuHpribyHw
- 原文: [raw](../../../raw/community-posts/aliyun-cloud-developer/2026-05-12-Agent-Skill规范构建与设计模式.md)
