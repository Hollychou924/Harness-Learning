---
id: source-card-community-aliyun-学习笔记从-Agent-到-Skills-—-AI-智能体架构的范式转变
type: source-card
status: triaged
source: wiki/raw/community-posts/aliyun-cloud-developer/2026-03-30-学习笔记从-Agent-到-Skills-—-AI-智能体架构的范式转变.md
updated: 2026-05-26
---

# 阿里云开发者文章卡 · 学习笔记：从 Agent 到 Skills — AI 智能体架构的范式转变

## 原文信息

- 来源: 阿里云开发者 微信公众号
- 作者: 元丹
- 发布时间: 2026/03/30 08:30:00
- URL: https://mp.weixin.qq.com/s/RMh2JqHwkjonPTZlwVKxsw
- 原文: [raw](../../../raw/community-posts/aliyun-cloud-developer/2026-03-30-学习笔记从-Agent-到-Skills-—-AI-智能体架构的范式转变.md)
