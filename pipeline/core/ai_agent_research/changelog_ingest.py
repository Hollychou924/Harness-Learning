...
from pipeline.core.ai_agent_research.changelog_entry import ChangelogEntry
from pipeline.core.llm_wiki.atomic import atomic_write_text
from pipeline.core.llm_wiki.ingest import IngestEngine, IngestSource, LLMClient
...
def write_changelog_report(
    *,
    ...
    """Generate a per-product daily changelog report at research/changelog/{product_id}/{date}.md.
