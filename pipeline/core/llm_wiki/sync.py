...
from pipeline.core.llm_wiki.ingest import IngestEngine, IngestError, IngestSource, LLMClient
...
from pipeline.sources.layer0_official.docs_site import fetch_sitemap_and_pages
from pipeline.sources.layer0_official.github_releases import fetch_releases
...
def sync_product_path_a(
    ...
    1. fetch sitemap + pages from docs_root → research/raw/{product}/{date}/
    2. fetch GitHub Releases (if github_repo set)
    3. ingest via two-step CoT into research/compiled/{product}/dimensions/
